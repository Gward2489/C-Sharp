...
namespace BankTeller
{
    public class DatabaseInterface
    {
        ...
        public DatabaseInterface()
        {
            ...
            _connectionString = $"Data Source=/home/gward2489/workspace/csharp/exercises/BankTeller/bankteller.db";
        ...
        public double getBalance(int accountId)
        {
            ...
            this.Query($@"SELECT Balance FROM Account WHERE Id={accountId}",
                (SqliteDataReader reader) => {
                    while (reader.Read ())
                    {
                        currentBalance = Convert.ToDouble(reader.GetInt32(0));
                    }
                }
            );   
